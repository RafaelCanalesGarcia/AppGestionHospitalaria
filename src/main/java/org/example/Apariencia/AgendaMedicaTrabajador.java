...
public class AgendaMedicaTrabajador extends JPanel {
    ...
    // todo mirar de poder actualizar la agenda de trabajador cuando eres trabajador
    public AgendaMedicaTrabajador(LocalDate date, String trabajador) {
